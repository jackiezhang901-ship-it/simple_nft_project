...
import (
	...
	logging "github.com/RCCHackathonTeam2/NFTAuctionBase/logger"
...
type ContractCfg struct {
	...
	NftAuctionAddress string `toml:"nftAuction_address" mapstructure:"dex_address" json:"nftAuction_address"`
}
